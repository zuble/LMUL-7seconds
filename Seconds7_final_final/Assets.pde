...
void saveData(StringList player, String[] player_log, String value, int num, int num_ronda) {

  //player.append("Pergunta " + np);
  player.append(value);
  ...
  saveStrings("data/ronda" + num_ronda + "_" + "player" + num + ".txt", player_log);
}
